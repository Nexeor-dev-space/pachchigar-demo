...
/* ═══════════════════════════════════════════
   WEDDING COLLECTION — Premium showcase section
   ═══════════════════════════════════════════ */

const COLLECTION = {
  name: "Wedding",
  tagline: "Wedding Collection",
  image: "/images/wedding-collection-banner.png",
  ctaLink: "/collections/wedding",
  ctaLabel: "Shop Wedding Collection",
};

const CAROUSEL_PRODUCTS = PRODUCTS.slice(2, 10);
const CARD_GAP = 16;
...
export default function WeddingCollection() {
  ...
  return (
    ...
    >
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-8 pt-4 pb-4 sm:pt-5 sm:pb-5 lg:pt-6 lg:pb-6 relative">
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 z-10">
                  ...
                  >
                    Wedding <span className="italic">Collection</span>
                  </h2>
                  <Link
